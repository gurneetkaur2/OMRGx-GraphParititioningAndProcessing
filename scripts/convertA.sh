...
##./part livejournal.graph;
##./partd wiki.graph;
./cedges adj_livejournal.graph >> outcedges;
./cedges adj_flickr.graph >> outcedges;
##./etoa friendster.graph edgelist;
##./etoa twitter.graph edgelist;
##./etoa-d ../inputs/livejournal.graph edgelist;
##./etoa ../inputs/livejournal.graph edgelist;
