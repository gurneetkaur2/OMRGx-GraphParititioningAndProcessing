...
#SBATCH --mem=425G
#SBATCH --time=0-18:00:00     # 1 day and 15 minutes 1-00:15:00
#SBATCH --mail-user=gkaur007@ucr.edu
#SBATCH --mail-type=ALL
#SBATCH --job-name="iU7-cnvtu7-newgraph"
...
./newgraph u7-gomed testCU7Gomed 8 105153952 >> outtu7 2>&1;
./newgraph u7-gomed testCU7Gomed 16 105153952 >> outtu7 2>&1;
./newgraph u7-gomed testCU7Gomed 24 105153952 >> outu7 2>&1;
