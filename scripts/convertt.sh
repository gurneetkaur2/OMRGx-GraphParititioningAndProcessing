...
#SBATCH --mem=425G
#SBATCH --time=4-02:00:00     # 1 day and 15 minutes 1-00:15:00
#SBATCH --mail-user=gkaur007@ucr.edu
#SBATCH --mail-type=ALL
#SBATCH --job-name="tu_Iconvert"
...
./etoa-d ../inputs/twitter.graph edgelist;
./etoa-d ../inputs/ukdomain.graph edgelist;
