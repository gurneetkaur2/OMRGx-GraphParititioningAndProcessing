...
#SBATCH --job-name="Cyc_OK_WKConvert"
...
## -- Make sure the first line about vertices and edges is removed from the file to avoid seg faults
##./newg ok-go testCOGohi 8 12150976 hi >> outtransok 2>&1;
##./newg ok-cyc testCFO 8 12150976 cyc >> outtranscok 2>&1;
##./newg ok-cyc testCLFO 8 12150976 lcyc >> outtransok2 2>&1;
##./newg ok-cyc testCLFO 8 12150976 lcyc >> outtransok2 2>&1;
./newgraph wk-cyc testCLFW 24 12150976 >> outtranswk2 2>&1;
##./newg ok-go testCOGomed 8 12150976 med >> outtransok 2>&1;
##./newg ok-go testCOGolo 8 12150976 lo >> outtransok 2>&1;

##./newgraph ok-gomed testCOGomed 16 12150976 >> outtransok 2>&1;
##./newgraph ok-gomed testCOGomed 24 12150976 >> outtransok 2>&1;
##./newg ok-gomed testCOGomed 16 3072441 med >> outtransok 2>&1;
##./newg ok-golo testCOGolo 24 3072441 lo >> outtransok 2>&1;

##./newgraph ok-gomod testCOGomod 8 3072441 >> outtransork 2>&1;
##./newgraph ok-gomed testCOGomed 16 3072441 >> outtransork 2>&1;
