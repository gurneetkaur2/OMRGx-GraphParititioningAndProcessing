...
npart=( 16 ); ## 8 16 24 32 ); ## 4 8 16 24 32 );
output=./outputs/;
partsD=parts_${npart};
testd=~/bigdata/gkaur007/datasets/inputs/${partsD}/;  ##/scratch/gkaur007/inputs/${partsD}/;   ###~/bigdata/gkaur007/datasets/inputs/${partsD}/;
vertices=105153952;
input=~/bigdata/gkaur007/datasets/inputs/uk7;   ##adj_ukdomain.graph;  ##/scratch/gkaur007/inputs/adj_ukdomain.graph;    ###~/bigdata/gkaur007/datasets/inputs/adj_ukdomain.graph;
ftype=adjlist;
outpre=testGUk7;
outf=intTUk732;
bsize=( 105153952 ); ##52576976 ); ##29288488 ); ## 78865464 52576976 29288488 ); ##26288488;   ##52576976;  ##105153952;
hideg=100000;
mappers=32;
gb=1;
k=200;
